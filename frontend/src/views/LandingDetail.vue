      ...
      <form v-on:submit.prevent="landing_check">
        ...
        <div class="form-group row">
          <div class="col-12">
            ...
            <button type="button" class="btn btn-info col-12 mt-2" @click="generate">파일 생성하기
            </button>
            <button type="button" class="btn btn-secondary col-12 mt-2" @click="just_back">목록으로
            </button>
            <button type="button" class="btn btn-danger col-12 mt-2" @click="delete_landing">삭제
            </button>
            <button type="button" class="btn btn-dark col-12 mt-2" @click="back_to_list">되돌리기
            </button>
          </div>
        </div>
                    ...
                    axios.get(this.$store.state.endpoints.baseUrl + 'landing_pages/' + this.$route.params.landing_id + '/')
                        .then((response) => {
                            ...
                            if (!response.data.data.landing_info.landing.tracking_info) {
                                this.temp_obj.landing_info.landing['tracking_info'] = {
                                    fb: '',
                                    ka: '',
                                    ga: '',
                                    gtm: '',
